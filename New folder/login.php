        ...
        <div class="middle">
            ...
            <form class="m-t" method="post" role="form" action="" enctype="multipart/form-data">
                <div class="form-group">
                    <input type="email" name="email" class="form-control" placeholder="Username"><span style="color:red"><?php if(!empty($errEmail)){echo "<br>".$errEmail."<br>";}?></span>
                </div>
                <div class="form-group">
                    <input type="password" name="pass"class="form-control" placeholder="Password">
					<span style="color:red"><?php if(!empty($errPassword)){echo "<br>".$errPassword."<br>";}?></span>
                </div>
