        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <tbody>
                    <?php
					$select=mysqli_query($conn,"select * from book_appointment where status=1");
					while($result=mysqli_fetch_array($select))
					{
						?>
						<tr>
							<td><?php $get=mysqli_query($conn,"select * from add_doctors where unique_id='$result[unique_id]'");
							$rst=mysqli_fetch_array($get);
							echo $rst['name'];?></td>
